...
const AdminRegisterPage = () => {
  ...
  return (
    <MainLayout>
      <section className="section" id="admin-register" style={{ minHeight: 'calc(100vh - 120px)', display: 'flex', alignItems: 'center' }}>
        <div className="container center">
          <div className="auth-card animate-fade-up" style={{ margin: '0 auto', maxWidth: 420, padding: '32px 28px', boxShadow: '0 4px 24px rgba(0,0,0,0.07)' }}>
            ...
            <p className="auth-sub-text">Create an administrator account for your platform</p>
            {registerError && (
              <div className="login-error" style={{ display: 'block' }}>
                {registerError}
              </div>
            )}
            <form id="admin-register-form" onSubmit={handleRegister} noValidate style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
              ...
              <button type="submit" className="btn btn-solid btn-block" id="register-submit" disabled={registerLoading}>
                {registerLoading ? 'Creating Admin...' : 'Register as Admin'}
              </button>
            </form>
