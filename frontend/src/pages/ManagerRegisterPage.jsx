...
const ManagerRegisterPage = () => {
  ...
  return (
    <MainLayout>
      <section className="section" id="manager-register" style={{ minHeight: 'calc(100vh - 120px)', display: 'flex', alignItems: 'center' }}>
        <div className="container center">
          <div className="auth-card animate-fade-up" style={{ margin: '0 auto', maxWidth: 420, padding: '32px 28px', boxShadow: '0 4px 24px rgba(0,0,0,0.07)' }}>
            ...
            <p className="auth-sub-text">Join us today with a 15-day free trial</p>
            <div style={{ backgroundColor: '#eff6ff', border: '1px solid #bfdbfe', borderRadius: 8, padding: '10px 14px', marginBottom: 20, fontSize: '0.85rem', color: '#1e40af', lineHeight: '1.4' }}>
              <strong>Note:</strong> New managers automatically receive a 15-day full-access trial period upon registration.
            </div>
            {registerError && (
            ...
            <form id="manager-register-form" onSubmit={handleRegister} noValidate style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
              ...
              <div style={{ margin: '10px 0 8px', fontSize: '0.95rem', color: '#666', textAlign: 'left' }}>
                By registering as a Manager, you agree to our
              ...
              <button type="submit" className="btn btn-solid btn-block" id="register-submit" disabled={registerLoading}>
                {registerLoading ? 'Creating Account...' : 'Register as Manager'}
              </button>
            </form>
